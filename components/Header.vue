    ...
    <div class="flex items-center justify-between">
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8">
          <li class="transform transition duration-300 hover:scale-125">
            <nuxt-link v-scroll-to="'#products'" to>デジタル活用支援推進事業</nuxt-link>
          </li>
          <li class="transform transition duration-300 hover:scale-125">
            <nuxt-link v-scroll-to="'#map'" to>会場案内</nuxt-link>
          </li>
          <li class="transform transition duration-300 hover:scale-125">
            <nuxt-link v-scroll-to="'#info'" to>開催情報</nuxt-link>
          </li>
        </ul>
      </div>
      ...
      <aside class="p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="divide-y">
          <li>
            <nuxt-link v-scroll-to="'#products'" to @click.native="isOpen = false" class="my-4 block">デジタル活用支援推進事業</nuxt-link>
          </li>
          <li>
            <nuxt-link v-scroll-to="'#map'" to @click.native="isOpen = false" class="my-4 block">会場案内</nuxt-link>
          </li>
          <li>
            <nuxt-link v-scroll-to="'#info'" to @click.native="isOpen = false" class="my-4 block">開催情報</nuxt-link>
          </li>
        </ul>
